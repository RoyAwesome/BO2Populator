...
public class BO2ObjectManager {
	...
	static void ReadBO2Files(String path) throws FileNotFoundException{
	...
	static ArrayList<BO2Object> getTrees(){
	...
	static ArrayList<BO2Object> getNotTrees(){
		ArrayList<BO2Object> objs = new ArrayList<BO2Object>();
		
		for(int i = 0; i< objects.size(); i++){
			
			if(!objects.get(i).isTree()) objs.add(objects.get(i));
